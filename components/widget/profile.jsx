    ...
    <>
      <div className="widget widget-view-profile">
        ...
        <ul className="profile-statistics">
          <li>
            <a href="#">
              <span className="item-number">{user?.Likes}</span>
              <span className="item-text">Likes</span>
            </a>
          </li>
          <li>
            <a href="#">
              <span className="item-number">{user?.Following}</span>
              <span className="item-text">Following</span>
            </a>
          </li>
          <li>
            <a href="#">
              <span className="item-number">{user?.Followed}</span>
        ...
        <div className="profile-btn">
          <a href={`/profile/?userId=${user.UserId}`} className="default-btn">
            View Profile
          </a>
        </div>
      </div>
